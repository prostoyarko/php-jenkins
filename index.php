...
<body>
    <section class="congratulations">
        ...
        <p>Hello World <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
    ...
    <section class="instructions">
        ...
        <ul>
            ...
            <li><a href="http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/create_deploy_PHP_eb.html">Zdarova</a></li>
